...
```bash
git clone https://github.com/attaponjantarato-maker/book-to-skill.git
cd book-to-skill
...
- Keep upstream authorship, license notices, and sponsor links intact. Submit
  general extractor fixes upstream when practical; changes specific to the
  medical/Hermes evidence lane belong in this fork.
